...
flowchart TB
    subgraph Ingestion["🔌 Ingestion Layer"]
        ...
        B["Live Capture<br/>(Research Mode)"]
...
|-------|-----------|---------|
| **Frontend** | Next.js 16, React 19, TypeScript, Tailwind CSS, Framer Motion, Three.js | Real-time SOC dashboard with 3D visualizations |
...
**27 tests** across 6 modules covering the highest-risk logic:
...
│   ├── main.py           # Core API: /detect, /triage, /approve, /reject, /events
...
│   ├── live_capture/     # Scapy packet capture (Research Mode)
